 ...
 * Generated for Laravel 5.6.39 on 2018-11-20 02:04:06.
 *
...
namespace Tanmo\Admin\Facades { 
    ...
    class Admin {
        ...
        {
            return \Tanmo\Admin\Admin::title();
        }
        ...
        {
            return \Tanmo\Admin\Admin::css($css);
        }
        ...
        {
            return \Tanmo\Admin\Admin::js($js);
        }
        ...
        {
            return \Tanmo\Admin\Admin::registerAdminRoutes();
        }
...
namespace Tanmo\Search\Facades { 
    ...
    class Search {
         ...
         *
         * @param \Closure $closure
         * @return \Tanmo\Search\Searcher 
         * @static 
         */ 
        public static function build($closure)
        {
            return \Tanmo\Search\Search::build($closure);
        }
...
namespace  { 
    ...
    class Search extends \Tanmo\Search\Facades\Search {}
