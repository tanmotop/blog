    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::articles.update', $article->id) }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="box-body">
                        <div class="fields-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="title" name="title" value="{{ $article->title }}" class="form-control" placeholder="输入 标题">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="file" class="banner" name="banner" id="banner" data-initial-preview="{{ $article->banner }}" data-initial-caption="{{ basename($article->banner) }}"  accept="image/*">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select style="width: 100%;" name="tags[]" id="tags" tabindex="-1" data-placeholder="选择标签" multiple class="form-control tags select2-hidden-accessible">
                                        @foreach($tags as $tag)
                                            <option value="{{ $tag->id }}" {{ in_array($tag->id, $article->tags->pluck('id')->all()) ? 'selected' : '' }}>{{ $tag->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="content" id="content" cols="30" rows="10" hidden>{{ $article->content }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="type" class="col-sm-2 control-label">文章类型</label>
                                <div class="col-sm-8">
                                    <label for="square-radio-1" class=""><input type="radio" id="square-radio-1" class="type" name="type" value="0" {{ $article->type == 0 ? 'checked' : '' }}>原创</label>
                                    &nbsp;
                                    <label for="square-radio-2" class=""><input type="radio" id="square-radio-2" class="type" name="type" value="1" {{ $article->type == 1 ? 'checked' : '' }}>转载</label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                        <input type="text" id="source" name="source" class="form-control" value="{{ $article->source }}" placeholder="输入 来源">
                                    </div>
                                </div>
                            </div>
                        </div>
